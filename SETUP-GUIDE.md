...
5. Create product webhooks (same URL for all):
...
6. Save and send test webhooks from Shopify
7. Verify:
...
4. Click Sign In
5. Open **Shopify Connection** from Orders or Products page and save your domain/token once.
